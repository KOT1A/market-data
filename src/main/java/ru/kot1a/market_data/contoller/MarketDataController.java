...
public class MarketDataController {
    ...
    @PostMapping
    public DataFromMoex getMarketData(@RequestBody CandleRequest candleRequest){
        log.debug("Тело запроса POST v1/market/data для получения свечей указанного инструмента за определённый " +
                "период: {}", candleRequest);
